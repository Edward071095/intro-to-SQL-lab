...
-- Write SQL query here
SELECT name FROM countries, countrylanguages WHERE countries.code = countrylanguages.countrycode AND countrylanguages.language = 'Italian' AND countrylanguages.percentage = 100;
--  San Marino
...
SELECT name FROM countries WHERE code = (SELECT countrycode FROM cities WHERE name = 'Serra');
--  Brazil
...
SELECT name FROM cities WHERE cities.id = 211;
--  Brasília
